...
function updateStats() {
    ...
    // Update counters
    // Ampliación deshabilitada para Natalia
...
function addWatermark(ctx, width, height, photoNumber) {
    ...
    // Add watermark text
    const watermarkText = 'Natalia Estévez';
...
function exportToJSON() {
    const exportData = {
        ...
        evento: 'XV Años - Natalia Estévez',
    ...
    const message = `👑 SELECCIÓN DE FOTOS - XV AÑOS NATALIA ESTÉVEZ\n\n${jsonText}`;
...
function generateTextSummary() {
    const stats = getStats();
    let summary = '👑 SELECCIÓN DE FOTOS - XV AÑOS NATALIA ESTÉVEZ\n';
    summary += '═══════════════════════════════════════\n\n';
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('🎬 Iniciando selector de fotos - Natalia Estévez XV Años');
